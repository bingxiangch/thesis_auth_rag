...
export const EditFileModel = ({ open, onClose, clickedUser }) => {
  ...
  const handleSaveChanges = () => {
    if (formData.password === formData.confirmpassword) {
      ...
      //   editedUser.username = formData.username
      // }
      // if (formData.password) {
      //   editedUser.password = formData.password
      // }
      // if (formData.role) {
      //   editedUser.role = formData.role
      // }
      // setValidationMessage(null)
      // setShowErrMsg(true)

      editedUser.file_name = clickedUser.file_name
        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
              <h3 className="text-3xl font-semibold">Edit File permission</h3>
              <button
                type="button"
                ...
                <div className="mt-4">
                  <div>
                    <label id="edit-username-label" className="block text-left">
                      FileName: {clickedUser.file_name}
                    </label>
